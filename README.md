...
### 📖 小说读者 / 下载党
- 想看**番茄小说 / 七猫小说**,但不想开会员、不想看广告?
- 想把喜欢的**小说下载成 TXT / EPUB** 存到本地、导入阅读器?
- 想一键看**两大平台的热门排行榜**(番茄综合/男频/女频 + 分类;七猫男生/女生 × 大热/新书/完结/收藏/更新)?

→ 本软件免费、无广告、无会员,一键搜索 → 下载 → 本地阅读。
...
- 🔎 **短剧后台搜索**:自动读取 Edge 登录态,查询**番茄短剧创作者中心**后台 IP
  - 打开番茄书籍详情时**自动搜索**,简介与下载按钮之间显示「📅上架 / 👥申请 / 🎬改编中」
  - 设置页可手动按书名搜索,查看**评分 / 字数 / 申请人数 / 同 IP 改编中 / 14 天在读 / 上架时间**
...
4. **查短剧 IP**(可选):先在 Edge 浏览器登录 `www.shortdramas.com`(番茄短剧创作者中心),本软件会自动读取该登录态。

> 短剧后台搜索依赖 Edge 的登录会话,会话过期后需在 Edge 重新登录。
